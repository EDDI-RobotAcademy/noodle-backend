...
urlpatterns = [
    ...
    path('register/writingReview', ReviewView.as_view({'post': 'registerNewWritingReview'}),
         name='writing-review-register'),
    path('register/selectionReview',
         ReviewView.as_view({'post': 'registerNewSelectionReview'}, name='selection-review-register')),
